...
function App() {
  ...
  <div className="column">
    <span className="column-title">Авторы</span>
    {authors && authors.map((author, index) => (
      <div className="author-data" key={index}>
        <div className="author-info">
          <div className="author-name">
            <span className="author-firstname">
              {author.name}
            </span>
            <span className="author-fathersname">
              {`${author.fathersname[0]}.`}
            </span>
            <span className="author-surname">
              {`${author.surname[0]}.`}
            </span>
          </div>
        </div>
